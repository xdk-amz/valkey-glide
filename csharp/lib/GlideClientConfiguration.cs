...
/// <summary>
/// Configuration settings for creating a standalone GLIDE client.
/// </summary>
public class GlideClientConfiguration : BaseClientConfiguration
{
    public GlideClientConfiguration(
