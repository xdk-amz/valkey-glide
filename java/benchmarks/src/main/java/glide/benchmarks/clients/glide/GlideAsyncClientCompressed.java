...
/** A Glide client with async capabilities and ZSTD compression enabled */
public class GlideAsyncClientCompressed implements AsyncClient<String> {
    private BaseClient glideClient;

    private static CompressionConfiguration compressionConfig() {
